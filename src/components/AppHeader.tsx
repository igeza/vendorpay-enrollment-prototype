...
export function AppHeader() {
  ...
  return (
    <header className="flex h-12 items-center bg-brand-navy px-md py-xs text-white">
      ...
      <div className="flex flex-1 items-center justify-center gap-xs">
        <div className="flex items-center gap-px">
          <button type="button" aria-label="Menu" className="flex h-8 w-10 items-center justify-center rounded-l-sm bg-[#425a70] hover:bg-[#4d6580]">
